...
using PN = Miracle.AomiToDB.ProviderName;
...
namespace Miracle.AomiToDB
{
    ...
    public static partial class Sql
    {
        ...
        [Sql.Property("Bit", ServerSideOnly = true)]
        public static Boolean Bit { get { return false; } }

        [Sql.Property(PN.Oracle, "Number(19)", ServerSideOnly = true)]
        [Sql.Property("BigInt", ServerSideOnly = true)]
        public static Int64 BigInt { get { return 0; } }

        [Sql.Property(PN.MySql, "Signed", ServerSideOnly = true)]
        [Sql.Property("Int", ServerSideOnly = true)]
        public static Int32 Int { get { return 0; } }

        [Sql.Property(PN.MySql, "Signed", ServerSideOnly = true)]
        [Sql.Property("SmallInt", ServerSideOnly = true)]
        public static Int16 SmallInt { get { return 0; } }
        ...
        [Sql.Property("TinyInt", ServerSideOnly = true)]
        public static Byte TinyInt { get { return 0; } }

        [Sql.Property("Decimal", ServerSideOnly = true)]
        public static Decimal DefaultDecimal { get { return 0; } }
        [Sql.Expression(PN.SapHana, "Decimal({0},4)", ServerSideOnly = true)]
        [Sql.Function(ServerSideOnly = true)]
        public static Decimal Decimal(int precision) { return 0; }
        [Sql.Function(ServerSideOnly = true)]
        public static Decimal Decimal(int precision, int scale) { return 0; }
        ...
        [Sql.Property("Money", ServerSideOnly = true)]
        public static Decimal Money { get { return 0; } }
        ...
        [Sql.Property("SmallMoney", ServerSideOnly = true)]
        public static Decimal SmallMoney { get { return 0; } }

        [Sql.Property(PN.MySql, "Decimal(29,10)", ServerSideOnly = true)]
        [Sql.Property(PN.SapHana, "Double", ServerSideOnly = true)]
        [Sql.Property("Float", ServerSideOnly = true)]
        public static Double Float { get { return 0; } }

        [Sql.Property(PN.MySql, "Decimal(29,10)", ServerSideOnly = true)]
        [Sql.Property("Real", ServerSideOnly = true)]
        public static Single Real { get { return 0; } }
        ...
        [Sql.Property("DateTime", ServerSideOnly = true)]
        ...
        [Sql.Property(PN.SapHana, "TimeStamp", ServerSideOnly = true)]
        [Sql.Property("DateTime2", ServerSideOnly = true)]
        public static DateTime DateTime2 { get { return DateTime.Now; } }
        ...
        [Sql.Property("SmallDateTime", ServerSideOnly = true)]
        public static DateTime SmallDateTime { get { return DateTime.Now; } }

        [Sql.Property(PN.SqlServer2000, "Datetime", ServerSideOnly = true)]
        [Sql.Property(PN.SqlServer2005, "Datetime", ServerSideOnly = true)]
        [Sql.Property(PN.SqlCe, "Datetime", ServerSideOnly = true)]
        [Sql.Property("Date", ServerSideOnly = true)]
        public static DateTime Date { get { return DateTime.Now; } }

        [Sql.Property("Time", ServerSideOnly = true)]
        public static DateTime Time { get { return DateTime.Now; } }
        ...
        [Sql.Property(PN.SapHana, "TimeStamp", ServerSideOnly = true)]
        [Sql.Property("DateTime", ServerSideOnly = true)]
        public static DateTimeOffset DateTimeOffset { get { return DateTimeOffset.Now; } }

        [Sql.Function(PN.SqlCe, "NChar", ServerSideOnly = true)]
        [Sql.Function(ServerSideOnly = true)]
        public static String Char(int length) { return ""; }

        [Sql.Property(PN.SqlCe, "NChar", ServerSideOnly = true)]
        [Sql.Property("Char", ServerSideOnly = true)]
        public static String DefaultChar { get { return ""; } }

        [Sql.Function(PN.MySql, "Char", ServerSideOnly = true)]
        [Sql.Function(PN.SqlCe, "NVarChar", ServerSideOnly = true)]
        [Sql.Function(ServerSideOnly = true)]
        public static String VarChar(int length) { return ""; }

        [Sql.Property(PN.MySql, "Char", ServerSideOnly = true)]
        [Sql.Property(PN.SqlCe, "NVarChar", ServerSideOnly = true)]
        [Sql.Property("VarChar", ServerSideOnly = true)]
        public static String DefaultVarChar { get { return ""; } }

        [Sql.Function(PN.DB2, "Char", ServerSideOnly = true)]
        [Sql.Function(ServerSideOnly = true)]
        public static String NChar(int length) { return ""; }

        [Sql.Property(PN.DB2, "Char", ServerSideOnly = true)]
        [Sql.Property("NChar", ServerSideOnly = true)]
        public static String DefaultNChar { get { return ""; } }
        ...
        [Sql.Function(PN.MySql, "Char", ServerSideOnly = true)]
        [Sql.Function(ServerSideOnly = true)]
        public static String NVarChar(int length) { return ""; }
        ...
        [Sql.Property(PN.MySql, "Char", ServerSideOnly = true)]
        [Sql.Property("NVarChar", ServerSideOnly = true)]
        public static String DefaultNVarChar { get { return ""; } }
        ...
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.Oracle, "Add{0}", false, 0, 2, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.DB2, "{{1}} + {0}", Precedence.Additive, true, new[] { "{0} Year", "({0} * 3) Month", "{0} Month", "{0} Day", "{0} Day", "({0} * 7) Day", "{0} Day", "{0} Hour", "{0} Minute", "{0} Second", "({0} * 1000) Microsecond" }, 0, 1, 2)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.Informix, "{{1}} + Interval({0}", Precedence.Additive, true, new[] { "{0}) Year to Year", "{0}) Month to Month * 3", "{0}) Month to Month", "{0}) Day to Day", "{0}) Day to Day", "{0}) Day to Day * 7", "{0}) Day to Day", "{0}) Hour to Hour", "{0}) Minute to Minute", "{0}) Second to Second", null }, 0, 1, 2)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.PostgreSQL, "{{1}} + {{0}} * Interval '1 {0}", Precedence.Additive, true, new[] { "Year'", "Month' * 3", "Month'", "Day'", "Day'", "Day' * 7", "Day'", "Hour'", "Minute'", "Second'", "Millisecond'" }, 0, 1, 2)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.MySql, "Date_Add({{1}}, Interval {{0}} {0})", true, new[] { null, null, null, "Day", null, null, "Day", null, null, null, null }, 0, 1, 2)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.SQLite, "DateTime({{1}}, '{{0}} {0}')", true, new[] { null, null, null, "Day", null, null, "Day", null, null, null, null }, 0, 1, 2)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.Access, "DateAdd({0}, {{0}}, {{1}})", true, new[] { "'yyyy'", "'q'", "'m'", "'y'", "'d'", "'ww'", "'w'", "'h'", "'n'", "'s'", null }, 0, 1, 2)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.SapHana, "Add_{0}", true, new[] { "Years({1}, {0})", "Months({1}, {0} * 3)", "Months({1}, {0})", "Days({1}, {0})", "Days({1}, {0})", "Days({1}, {0} * 7)", "Days({1}, {0})", "Seconds({1}, {0} * 3600)", "Seconds({1}, {0} * 60)", "Seconds({1}, {0})", null }, 0, 1, 2)]
        ...
        [CLSCompliant(false)]
        [Sql.Function]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.DB2, "{0}", false, new[] { null, null, null, null, null, null, "DayOfWeek", null, null, null, null }, 0, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.Informix, "{0}", 0, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.MySql, "Extract({0} from {{0}})", true, 0, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.PostgreSQL, "Extract({0} from {{0}})", true, new[] { null, null, null, "DOY", null, null, "DOW", null, null, null, null }, 0, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.Firebird, "Extract({0} from {{0}})", true, new[] { null, null, null, "YearDay", null, null, null, null, null, null, null }, 0, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.Oracle, "To_Number(To_Char({{0}}, {0}))", true, new[] { "'YYYY'", "'Q'", "'MM'", "'DDD'", "'DD'", "'WW'", "'D'", "'HH24'", "'MI'", "'SS'", "'FF'" }, 0, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.SQLite, "Cast(StrFTime({0}, {{0}}) as int)", true, new[] { "'%Y'", null, "'%m'", "'%j'", "'%d'", "'%W'", "'%w'", "'%H'", "'%M'", "'%S'", "'%f'" }, 0, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.Access, "DatePart({0}, {{0}})", true, new[] { "'yyyy'", "'q'", "'m'", "'y'", "'d'", "'ww'", "'w'", "'h'", "'n'", "'s'", null }, 0, 1)]
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.SapHana, "{0}", true, new[] { "Year({0})", "Floor((Month({0})-1) / 3) + 1", "Month({0})", "DayOfYear({0})", "DayOfMonth({0})", "Week({0})", "MOD(Weekday({0}) + 1, 7) + 1", "Hour({0})", "Minute({0})", "Second({0})", null }, 0, 1)]
        ...
        [Miracle.AomiToDB.Sql.DatePartAttribute(PN.SapHana, "{0}", true, new[] { null, null, null, null, "Days_Between({0}, {1})", null, null, "Seconds_Between({0}, {1}) / 3600", "Seconds_Between({0}, {1}) / 60", "Seconds_Between({0}, {1})", "Nano100_Between({0}, {1}) / 10000" }, 0, 1, 2)]
        ...
        [Sql.Function]
        public static Decimal? Abs(Decimal? value) { return value == null ? null : (Decimal?)Math.Abs(value.Value); }
        [Sql.Function]
        public static Double? Abs(Double? value) { return value == null ? null : (Double?)Math.Abs(value.Value); }
        [Sql.Function]
        public static Int16? Abs(Int16? value) { return value == null ? null : (Int16?)Math.Abs(value.Value); }
        [Sql.Function]
        public static Int32? Abs(Int32? value) { return value == null ? null : (Int32?)Math.Abs(value.Value); }
        [Sql.Function]
        public static Int64? Abs(Int64? value) { return value == null ? null : (Int64?)Math.Abs(value.Value); }
        [CLSCompliant(false)]
        [Sql.Function]
        public static SByte? Abs(SByte? value) { return value == null ? null : (SByte?)Math.Abs(value.Value); }
        [Sql.Function]
        public static Single? Abs(Single? value) { return value == null ? null : (Single?)Math.Abs(value.Value); }

        [Sql.Function]
        public static Double? Acos(Double? value) { return value == null ? null : (Double?)Math.Acos(value.Value); }
        [Sql.Function]
        public static Double? Asin(Double? value) { return value == null ? null : (Double?)Math.Asin(value.Value); }

        [Sql.Function(PN.Access, "Atn")]
        [Sql.Function]
        public static Double? Atan(Double? value) { return value == null ? null : (Double?)Math.Atan(value.Value); }
        ...
        [Sql.Function]
        public static Double? Atan2(Double? x, Double? y) { return x == null || y == null ? null : (Double?)Math.Atan2(x.Value, y.Value); }

        [Sql.Function(PN.Informix, "Ceil")]
        [Sql.Function(PN.Oracle, "Ceil")]
        [Sql.Function(PN.SapHana, "Ceil")]
        [Sql.Function]
        public static Decimal? Ceiling(Decimal? value) { return value == null ? null : (Decimal?)decimal.Ceiling(value.Value); }

        [Sql.Function(PN.Informix, "Ceil")]
        [Sql.Function(PN.Oracle, "Ceil")]
        [Sql.Function(PN.SapHana, "Ceil")]
        [Sql.Function]
        public static Double? Ceiling(Double? value) { return value == null ? null : (Double?)Math.Ceiling(value.Value); }

        [Sql.Function]
        public static Double? Cos(Double? value) { return value == null ? null : (Double?)Math.Cos(value.Value); }

        [Sql.Function]
        public static Double? Cosh(Double? value) { return value == null ? null : (Double?)Math.Cosh(value.Value); }

        [Sql.Function]
        public static Double? Cot(Double? value) { return value == null ? null : (Double?)Math.Cos(value.Value) / Math.Sin(value.Value); }

        [Sql.Function]
        public static Decimal? Degrees(Decimal? value) { return value == null ? null : (Decimal?)(value.Value * 180m / (Decimal)Math.PI); }
        [Sql.Function]
        public static Double? Degrees(Double? value) { return value == null ? null : (Double?)(value.Value * 180 / Math.PI); }
        [Sql.Function]
        public static Int16? Degrees(Int16? value) { return value == null ? null : (Int16?)(value.Value * 180 / Math.PI); }
        [Sql.Function]
        public static Int32? Degrees(Int32? value) { return value == null ? null : (Int32?)(value.Value * 180 / Math.PI); }
        [Sql.Function]
        public static Int64? Degrees(Int64? value) { return value == null ? null : (Int64?)(value.Value * 180 / Math.PI); }
        [CLSCompliant(false)]
        [Sql.Function]
        public static SByte? Degrees(SByte? value) { return value == null ? null : (SByte?)(value.Value * 180 / Math.PI); }
        [Sql.Function]
        public static Single? Degrees(Single? value) { return value == null ? null : (Single?)(value.Value * 180 / Math.PI); }

        [Sql.Function]
        public static Double? Exp(Double? value) { return value == null ? null : (Double?)Math.Exp(value.Value); }

        [Sql.Function(PN.Access, "Int")]
        [Sql.Function]
        public static Decimal? Floor(Decimal? value) { return value == null ? null : (Decimal?)decimal.Floor(value.Value); }

        [Sql.Function(PN.Access, "Int")]
        [Sql.Function]
        public static Double? Floor(Double? value) { return value == null ? null : (Double?)Math.Floor(value.Value); }
        ...
        [Sql.Function]
        public static Decimal? Log(Decimal? value) { return value == null ? null : (Decimal?)Math.Log((Double)value.Value); }
        ...
        [Sql.Function(PN.SapHana, "Ln")]
        [Sql.Function]
        public static Double? Log(Double? value) { return value == null ? null : (Double?)Math.Log(value.Value); }

        [Sql.Function(PN.PostgreSQL, "Log")]
        [Sql.Expression(PN.SapHana, "Log(10,{0})")]
        [Sql.Function]
        public static Double? Log10(Double? value) { return value == null ? null : (Double?)Math.Log10(value.Value); }
        ...
        [Sql.Function(PN.Access, "Sgn"), Sql.Function]
        public static int? Sign(Decimal? value) { return value == null ? null : (int?)Math.Sign(value.Value); }
        [Sql.Function(PN.Access, "Sgn"), Sql.Function]
        public static int? Sign(Double? value) { return value == null ? null : (int?)Math.Sign(value.Value); }
        [Sql.Function(PN.Access, "Sgn"), Sql.Function]
        public static int? Sign(Int16? value) { return value == null ? null : (int?)Math.Sign(value.Value); }
        [Sql.Function(PN.Access, "Sgn"), Sql.Function]
        public static int? Sign(Int32? value) { return value == null ? null : (int?)Math.Sign(value.Value); }
        [Sql.Function(PN.Access, "Sgn"), Sql.Function]
        public static int? Sign(Int64? value) { return value == null ? null : (int?)Math.Sign(value.Value); }
        [CLSCompliant(false)]
        [Sql.Function(PN.Access, "Sgn"), Sql.Function]
        public static int? Sign(SByte? value) { return value == null ? null : (int?)Math.Sign(value.Value); }
        [Sql.Function(PN.Access, "Sgn"), Sql.Function]
        public static int? Sign(Single? value) { return value == null ? null : (int?)Math.Sign(value.Value); }

        [Sql.Function]
        public static Double? Sin(Double? value) { return value == null ? null : (Double?)Math.Sin(value.Value); }
        [Sql.Function]
        public static Double? Sinh(Double? value) { return value == null ? null : (Double?)Math.Sinh(value.Value); }
        [Sql.Function(PN.Access, "Sqr")]
        [Sql.Function]
        public static Double? Sqrt(Double? value) { return value == null ? null : (Double?)Math.Sqrt(value.Value); }
        [Sql.Function]
        public static Double? Tan(Double? value) { return value == null ? null : (Double?)Math.Tan(value.Value); }
        [Sql.Function]
        public static Double? Tanh(Double? value) { return value == null ? null : (Double?)Math.Tanh(value.Value); }
