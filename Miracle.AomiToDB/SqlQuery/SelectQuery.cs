...
{
    using Miracle.AomiToDB.Extensions;
    using Reflection;
    /// <summary>
    /// 用于将来组装SQL语句的信息类
    /// </summary>
    ...
    public class SelectQuery : ISqlTableSource
    {
        ...
        public class SelectClause : ClauseBase, IQueryElement, ISqlExpressionWalkable
        {
            ...
            internal SelectClause(SelectQuery selectQuery)
                : base(selectQuery)
            {
            }
        ...
        public class FromClause : ClauseBase, IQueryElement, ISqlExpressionWalkable
        {
            ...
            internal FromClause(SelectQuery selectQuery)
                : base(selectQuery)
            {
            }
        ...
        public class WhereClause : ClauseBase<WhereClause, WhereClause.Next>, IQueryElement, ISqlExpressionWalkable
        {
            ...
            {
                internal Next(WhereClause parent)
                    : base(parent.SelectQuery)
                {
                    _parent = parent;
                }
            ...
            internal WhereClause(SelectQuery selectQuery)
                : base(selectQuery)
            {
            ...
            internal WhereClause(SearchCondition searchCondition)
                : base(null)
            {
        ...
        {
            internal GroupByClause(SelectQuery selectQuery)
                : base(selectQuery)
            {
            }
            ...
            internal GroupByClause(IEnumerable<ISqlExpression> items)
                : base(null)
            {
        ...
        {
            internal OrderByClause(SelectQuery selectQuery)
                : base(selectQuery)
            {
            }
            ...
            internal OrderByClause(IEnumerable<OrderByItem> items)
                : base(null)
            {
                _items.AddRange(items);
            }
