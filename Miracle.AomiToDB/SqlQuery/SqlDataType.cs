...
namespace Miracle.AomiToDB.SqlQuery
{
	...
	public class SqlDataType : ISqlExpression
	{
		...
		public SqlDataType(DataType dbType, Type type)
		{
			if (type == null) throw new ArgumentNullException("type");
		...
		public SqlDataType(DataType dbType,  Type type, int length)
		{
			if (type   == null) throw new ArgumentNullException      ("type");
			if (length <= 0)    throw new ArgumentOutOfRangeException("length");
		...
		public SqlDataType(DataType dbType,  Type type, int precision, int scale)
		{
			if (type  == null)  throw new ArgumentNullException      ("type");
			if (precision <= 0) throw new ArgumentOutOfRangeException("precision");
			if (scale     <  0) throw new ArgumentOutOfRangeException("scale");
