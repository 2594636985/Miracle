...
namespace Miracle.AomiToDB.Extensions
{
    /// <summary>
    /// 反射部分的扩展方法
    /// </summary>
    public static class ReflectionExtensions
    {
        ...
        public static Type GetListItemType(this Type listType)
        {
            ...
            if (typeof(IList).IsSameOrParentOf(listType) || typeof(ITypedList).IsSameOrParentOf(listType) || typeof(IListSource).IsSameOrParentOf(listType))
            {
