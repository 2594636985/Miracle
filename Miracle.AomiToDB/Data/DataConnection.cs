...
namespace Miracle.AomiToDB.Data
{
    ...
    public partial class DataConnection : ICloneable
    {
        ...
        public DataConnection(string configurationString)
        {
            ...
            if (ConfigurationString == null)
                throw new AomiToDBException("Configuration string is not provided.");
        ...
        public DataConnection( string providerName,  string connectionString)
        {
            ...
            if (!_dataProviders.TryGetValue(providerName, out dataProvider))
                throw new AomiToDBException("DataProvider '{0}' not found.".Args(providerName));
 ...
 "Warning"
        ...
        static DataConnection()
        {
            ...
            Miracle.AomiToDB.DataProvider.Access.AccessTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.SqlCe.SqlCeTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.Firebird.FirebirdTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.MySql.MySqlTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.SQLite.SQLiteTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.Sybase.SybaseTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.Oracle.OracleTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.PostgreSQL.PostgreSQLTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.DB2.DB2Tools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.Informix.InformixTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.SapHana.SapHanaTools.GetDataProvider();
            Miracle.AomiToDB.DataProvider.SqlServer.SqlServerTools.GetDataProvider();
        ...
        static ConfigurationInfo GetConfigurationInfo(string configurationString)
        {
            ...
            throw new AomiToDBException("Configuration '{0}' is not defined.".Args(configurationString));
        }
