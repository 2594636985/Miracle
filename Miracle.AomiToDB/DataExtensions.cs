...
namespace Miracle.AomiToDB
{
	...
	public static class DataExtensions
	{
		...
		public static int Insert<T>( this IDataContextInfo dataContextInfo, T obj,
		...
		public static object InsertWithIdentity<T>( this IDataContextInfo dataContextInfo, T obj)
		{
			if (dataContextInfo == null) throw new ArgumentNullException("dataContextInfo");
		...
		public static int Update<T>( this IDataContextInfo dataContextInfo, T obj)
		{
			if (dataContextInfo == null) throw new ArgumentNullException("dataContextInfo");
		...
		public static int Delete<T>( this IDataContextInfo dataContextInfo, T obj)
		{
			if (dataContextInfo == null) throw new ArgumentNullException("dataContextInfo");
		...
		public static ITable<T> CreateTable<T>( this IDataContextInfo dataContextInfo,
		...
		public static ITable<T> CreateTable<T>( this IDataContext dataContext,
			string         tableName       = null,
			string         databaseName    = null,
			string         ownerName       = null,
			string         statementHeader = null,
		...
		public static void DropTable<T>( this IDataContextInfo dataContextInfo,
			string tableName    = null,
			string databaseName = null,
		...
		public static void DropTable<T>( this IDataContext dataContext, string tableName = null, string databaseName = null, string schemaName = null)
		{
			if (dataContext == null) throw new ArgumentNullException("dataContext");
			Query<T>.DropTable(DataContextInfo.Create(dataContext), tableName, databaseName, schemaName);
		}

		public static void DropTable<T>( this ITable<T> table, string tableName = null, string databaseName = null, string schemaName = null)
		{
